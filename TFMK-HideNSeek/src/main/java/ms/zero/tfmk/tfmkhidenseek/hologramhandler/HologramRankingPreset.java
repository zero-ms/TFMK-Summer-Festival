...
import ms.zero.tfmk.tfmkhidenseek.gamehandler.GamePlayer;
...
public class HologramRankingPreset {
    ...
    public static Hologram getKillRanking(Integer index) {
        return firstPageHologramSet.get(index);
    }

    public static Hologram getKeyRanking(Integer index) {
        return secondPageHologramSet.get(index);
    }
}
